...
/* harmony import */ var _home_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home.css */ "./src/home/home.css");
...
new (vue__WEBPACK_IMPORTED_MODULE_0___default())({
  ...
  mounted: function mounted() {
    this.userInfo = Native.common.getUserInfo();
  },
  methods: {
    add: function add() {
      var result = Native.common.add({
        a: parseInt(this.addInfo.a),
        b: parseInt(this.addInfo.b)
      });
    ...
    download: function download() {
      ...
      var result = Native.download.download({}, function (file) {
        _this.$message('下载完成:' + file);
      }, function (error) {
        _this.$message('下载失败:' + error);
      }, function (progress) {
    ...
    showDlg: function showDlg() {
      var _this2 = this;
      var args = {};
      if (this.dlg.leftButton) {
        args.leftButton = this.dlg.leftButton;
      }
      if (this.dlg.rightButton) {
        args.rightButton = this.dlg.rightButton;
      }
      if (this.dlg.message) {
        args.message = this.dlg.message;
      }
      if (this.dlg.title) {
        args.title = this.dlg.title;
      }
      var dlgId = Native.ui.showAlert(args, function (result) {
        result = JSON.parse(result);
        if (result.event == 'onClick') {
          if (result.button == "left") {
            _this2.$message('左边按钮被点击');
            Native.ui.dismissAlert({
              id: dlgId
            });
          }
          if (result.button == "right") {
            _this2.$message('右边按钮被点击');
            Native.ui.dismissAlert({
              id: dlgId
            });
          }
        } else if (result.event == 'onDismiss') {
          _this2.$message('弹窗被关闭');
        }
      });
    }
  }
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      /*! !!../../node_modules/css-loader/dist/cjs.js!./home.css */ "./node_modules/css-loader/dist/cjs.js!./src/home/home.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_home_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./home.css */ "./node_modules/css-loader/dist/cjs.js!./src/home/home.css");
(function () {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "webpack_test:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatewebpack_test"] = (chunkId, moreModules, runtime) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/home/home.js");
/******/ 	
/******/ })()
;
